...
places_longlat = pd.read_csv('data/places_italy_longlat.csv', usecols = ['places','latitude', 'longitude'], index_col = False)
...
data = pd.read_csv('data/italy_output_id.csv',
...
data.to_csv('italy_geolocated_id.csv')
