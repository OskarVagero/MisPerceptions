...
places_longlat = pd.read_csv('data/places_france_longlat.csv', usecols = ['places','latitude', 'longitude'], index_col = False)
...
data = pd.read_csv('data/france_output_id.csv',
...
data.to_csv('france_geolocated_id.csv')
